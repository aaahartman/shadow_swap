...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/data/Levels/_l20.oel", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			type.set ("assets/images/levelButton.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/levelButton1.png", "assets/images/levelButton1.png");
			type.set ("assets/images/levelButton1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/levelButton2.png", "assets/images/levelButton2.png");
			type.set ("assets/images/levelButton2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/levelButton3.png", "assets/images/levelButton3.png");
			type.set ("assets/images/levelButton3.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/levelButton4.png", "assets/images/levelButton4.png");
			type.set ("assets/images/levelButton4.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/lvlButton.png", "assets/images/lvlButton.png");
			type.set ("assets/images/lvlButton.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/nxtButton.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/Stars0.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Stars1.png", "assets/images/Stars1.png");
			type.set ("assets/images/Stars1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Stars2.png", "assets/images/Stars2.png");
			type.set ("assets/images/Stars2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/Stars3.png", "assets/images/Stars3.png");
			type.set ("assets/images/Stars3.png", Reflect.field (AssetType, "image".toUpperCase ()));
