...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/data/levels/level5.oel", "assets/data/levels/level5.oel");
			type.set ("assets/data/levels/level5.oel", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			path.set ("assets/images/bettertiles.png", "assets/images/bettertiles.png");
			type.set ("assets/images/bettertiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/evenbettertiles.png", "assets/images/evenbettertiles.png");
			type.set ("assets/images/evenbettertiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
